...
import { AddressTxCounts, UTXO as LitecoinUTXO } from '../../types';
import { decodeRawTransaction, normalizeTransactionObject } from '../../utils';
import { LitecoinBaseChainProvider } from '../LitecoinBaseChainProvider';
import { ProviderOptions, ReceivedByAddress, UTXO } from './types';

export class LitecoinJsonRpcBaseProvider extends LitecoinBaseChainProvider {
    ...
    public async getUnspentTransactions(_addresses: AddressType[]): Promise<LitecoinUTXO[]> {
