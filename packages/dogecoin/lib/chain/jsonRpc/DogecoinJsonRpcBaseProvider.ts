...
import { AddressTxCounts, UTXO as DogecoinUTXO } from '../../types';
...
export class DogecoinJsonRpcBaseProvider extends DogecoinBaseChainProvider {
    ...
    public async getUnspentTransactions(_addresses: AddressType[]): Promise<DogecoinUTXO[]> {
